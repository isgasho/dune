...
// 	case Float:
// 		return json.Marshal(v.ToFloat())
// 	case Bool:
// 		return json.Marshal(v.ToBool())
// 	case String:
// 		return json.Marshal(v.ToString())
// 	case Rune:
// 		return json.Marshal(v.ToRune())
// 	case Null, Undefined:
// 		return json.Marshal(nil)
// 	case Bytes:
// 		return json.Marshal(v.ToBytes())
// 	case Map:
...
// 				return nil, err
// 			}
// 			buffer.WriteString(fmt.Sprintf("\"%s\":%s", string(jsonKey), string(jsonValue)))
// 			count++
// 			if count < length {
// 				buffer.WriteString(",")
// 			}
...
// 	case Array:
// 		return json.Marshal(v.ToArray())
// 	case Object:
// 		return json.Marshal(v.TypeName())
// 	default:
// 		return json.Marshal(v.Export(0))
// 	}
// }
